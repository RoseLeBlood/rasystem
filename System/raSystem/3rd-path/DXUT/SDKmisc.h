...
//--------------------------------------------------------------------------------------
HRESULT WINAPI DXUTFindDXSDKMediaFileCch( __out_ecount(cchDest) CHAR* strDestPath,
                                          __in int cchDest, 
                                          __in LPCSTR strFilename );
HRESULT WINAPI DXUTSetMediaSearchPath( LPCSTR strPath );
LPCSTR WINAPI DXUTGetMediaSearchPath();
